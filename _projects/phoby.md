...
tech: Built in Unity with C# for Oculus Quest. 3D models created in Blender and textured with Quixel. Implemented Quest controller tracking and custom UI elements.
links:
  - label: GitHub (HackDuke)
    url: https://github.com/inessaid/HackDuke
  - label: GitHub (HackHarvard)
    url: https://github.com/inessaid/VRtherapy
  - label: Devpost (Phoby)
