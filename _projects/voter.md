...
tech: Built in Unity for Google Cardboard. Google Firebase for authentication and user data. 3D assets modeled in Maya and textured in Substance Painter. All assets created from scratch—no imported assets or textures.
links:
  - label: GitHub
    url: https://github.com/Linkraft/VoteR
  - label: Devpost
    url: https://devpost.com/software/voter-7xrsoi
video: CurNqGTqgCY
