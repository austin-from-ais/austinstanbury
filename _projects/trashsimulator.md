...
tech: Built in Unity for Oculus Quest. Integrated IBM Watson (Assistant, Speech-to-Text, Text-to-Speech), Google Firebase Authentication. 3D assets modeled in Maya and textured in Substance Painter.
links:
  - label: GitHub
