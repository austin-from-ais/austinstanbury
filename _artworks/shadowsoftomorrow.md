...
tech: Built in Unity with C#. Extended reality installation combining immersive storytelling with climate data visualization. Published at ACM VRST 2023 in Christchurch, New Zealand.
links:
  - label: ACM Digital Library
    url: https://doi.org/10.1145/3611659.3617195
  - label: Gainesville Fine Arts Association
    url: https://www.gainesvillefinearts.org/product-page/shadows-of-tomorrow-ines-said-austin-stanbury
  - label: AWE XR Challenge Coverage
    url: https://arpost.co/2023/02/02/150-projects-awe-xr-challenge-climate-change/
  - label: UF Hub Gallery Wall
    url: https://calendar.hr.ufl.edu/event/hub-gallery-wall-artists-reception-networking/
  - label: Parsons Guest Lecture
    url: https://www.instagram.com/p/DIezSLFyyIO/
  - label: Jane Gilbert — One Billion Resilient
    url: https://onebillionresilient.org/expert/jane-gilbert/
---
...
The work was published at ACM VRST 2023 (29th ACM Symposium on Virtual Reality Software and Technology) in Christchurch, New Zealand as "Immersive Climate Narratives: Using Extended Reality to Raise Climate Change Awareness" with Ines Said, Erica Delhagen, and Hyoungah Kang.
...
Built with Ines Said, Erica Delhagen, and Hyoungah Kang.
